  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Sign in to your Business360 account.</CardDescription>
      </CardHeader>
        ...
        <CardFooter className="flex flex-col gap-3">
          ...
          <div className="grid grid-cols-2 gap-2 w-full">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 rounded-lg border border-border bg-background px-3 py-2 text-sm font-medium hover:bg-muted transition-colors"
            >
